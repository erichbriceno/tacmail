...
<head>
	...
	<title>TACMAIL - CosulCorrespondencia</title>
		...
		<section class="main container">
			...
			<section class="col-md-8">
				<article class="post clearfix">
					...
					<h2 class="post-title pull-right">509127674</h2>
					<p>26 de Enero de 2016<br>Jhonny Herrera<br>08N43704</p>
					<p class="text-justify">
						Observacion: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam dignissimos ipsam aspernatur ratione est dolor consectetur. Consectetur, quia aperiam ipsam inventore quo nobis pariatur facere a nemo vel molestias placeat!Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, asperiores, placeat, non odit vitae blanditiis illum ex dolore dignissimos est aut tempore officia recusandae mollitia eius commodi impedit a corporis!
					</p>
			...
			<section class="col-md-3">
				<form action="" class="navbar-form mright" role="search">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Buscar Valija #">
					</div>
				</form>
				<h4>Recibidas</h4>
				<ul class="list-group">
